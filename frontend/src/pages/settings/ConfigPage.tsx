    ...
    <div className="container max-w-screen-xl mx-auto px-4 py-6 sm:px-6 sm:py-8">
      ...
      {isFetchingConfig ? (
        <div className="flex flex-col items-center justify-center py-20 animate-in fade-in duration-500">
          ...
          <p className="mt-6 text-gray-500 dark:text-zinc-400 font-medium">Đang tải cấu hình...</p>
        </div>
      ) : (
              ...
              <CardContent className="p-5">
                <div className="space-y-5">
                  ...
                  <div className="space-y-3">
                    ...
                    {/* Profile list */}
                    <div className="overflow-hidden rounded-lg border border-gray-100 dark:border-zinc-800 bg-white dark:bg-zinc-900/50 shadow-sm">
                      {profiles.length === 0 ? (
                        <div className="p-8 text-center">
                          <div className="mx-auto w-12 h-12 rounded-full bg-gray-100 dark:bg-zinc-800/80 flex items-center justify-center mb-3">
                            <Users className="w-6 h-6 text-gray-400 dark:text-zinc-500" />
                          </div>
                          <h3 className="text-sm font-medium text-gray-700 dark:text-zinc-300 mb-1">Chưa có profile nào</h3>
                          <p className="text-xs text-gray-500 dark:text-zinc-400 mb-4">Hãy tạo profile đầu tiên của bạn</p>
                          <Button
                            size="sm"
                        ...
                        profiles.map((profile, index) => (
                          <div
                            key={profile.id}
                            className={`relative transition-all cursor-pointer ${index !== 0 ? 'border-t border-gray-100 dark:border-zinc-800' : ''
                              } ${selectedProfileId === profile.id ? 'bg-indigo-50/50 dark:bg-indigo-900/10' : 'hover:bg-gray-50 dark:hover:bg-zinc-800/50'
                              }`}
                              ...
                              <div className="p-4">
                                <div className="flex items-start justify-between">
                                  <div className="flex-1 min-w-0">
                                    <div className="font-medium flex items-center text-gray-900 dark:text-zinc-100 mb-1">
                                      {profile.name}
                                      {profile.is_active && (
                                    ...
                                    <div className="mt-2 flex flex-wrap gap-1.5">
                                      <span className="inline-flex items-center rounded-md px-2 py-1 text-xs font-medium bg-gray-100 text-gray-800 dark:bg-zinc-800 dark:text-zinc-300">
                                        {profile.db_name}
                                      </span>
                                      <span className="inline-flex items-center rounded-md px-2 py-1 text-xs font-medium bg-gray-100 text-gray-800 dark:bg-zinc-800 dark:text-zinc-300">
              ...
              <CardContent className="p-5">
                <div className="space-y-4">
                  <form onSubmit={handleSave} className="space-y-6">
                    ...
                    <div className="rounded-lg border border-gray-100 dark:border-zinc-800 bg-white dark:bg-zinc-900/50 overflow-hidden shadow-sm">
                      <div className="bg-gray-50 dark:bg-zinc-800/30 px-4 py-3 border-b border-gray-100 dark:border-zinc-800">
                        <h3 className="text-sm font-medium text-gray-700 dark:text-zinc-300 flex items-center">
